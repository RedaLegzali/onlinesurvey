                        ...
                        <?php if (! $this->session->userdata('logged_in') ): ?>
                            <div class="row  justify-content-center mt-3" style="height: 10%;">
                                <div class="col-8 col-md-7 col-lg-6 col-xl-7 " style="text-align: center;">
                                    <label class="sr-only">الإ سم</label>
                                        <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"s><i class="fas fa-user" style="font-size: 13px"></i></div>
                                        </div>
                                        <input type="text" class="form-control" id="register_name" placeholder="الإ سم">
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="row  justify-content-center mt-4" style="height: 10%;">
                                <div class="col-8 col-md-7 col-lg-6 col-xl-7" style="text-align: center;">
                                    <label class="sr-only">البريد الإلكتروني</label>
                                        ...
                                        <input type="text" class="form-control" id="register_email" placeholder="البريد الإلكتروني">
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center mt-4" style="height: 10%;">
                                <div class="col-8 col-md-7 col-lg-6 col-xl-7" style="text-align: center;">
                                    <label class="sr-only">كلمة السر</label>
                                        ...
                                        <input type="password" class="form-control" id="register_password" placeholder="كلمة السر">
                                        </div>
                                </div>
                            </div>
                            <div class="row justify-content-center mt-4" style="height: 10%;">
                                <div class="col-8 col-md-7 col-lg-6 col-xl-7" style="text-align: center;">
                                    <label class="sr-only">تأكيد كلمة المرور</label>
                                        ...
                                        <input type="password" class="form-control" id="register_password_confirm" placeholder="تأكيد كلمة المرور" style="overflow-y:scroll;">
                                        </div>
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="row justify-content-center mt-4" style="height: 10%;">
                            <div class="col-8 col-md-7 col-lg-6 col-xl-7" style="text-align: center;" >
                                ...
                                <div class="input-group" style="margin-top: 20px;">
                                    ...
                                    <input type="text"  id="emails" data-role="tagsinput"   placeholder="               أرسل إلى" >
                                </div>
                            </div>
                        </div>
...
<footer >
    ...
    إرسال <i class='fas fa-paper-plane'></i> <!-- Store it + Ajax email sending -->
    </button>
    
    <?php if( $this->session->userdata('logged_in') ): ?>
        <a id='save'>
            <button class="btn btn-primary" style="font-size: 20px;font-weight: bold;">
            حفظ <i class="fas fa-cloud-download-alt"></i> <!-- On Click submit surveys/store -->
            </button>
        </a>
    <?php endif; ?>
</footer>
                ...
                success : function(data){
                    if ( data['error'] == true){
                        if (data['empty']){
                            ...
                            $('#messages').css('display' , 'block');
                            $('#messages').removeClass('alert-success').addClass('alert-danger')
                            $('#messages').text('يتم تكرار نفس السؤال مرتين أو أكثر');
                            window.location.href = '#title_label';
                        }
                        else{ 
                            $('input').css('border-bottom' , '1px solid #757575');
                            ...
                            $('#messages').css('display' , 'block');
                            $('#messages').removeClass('alert-success').addClass('alert-danger')
                            $('#messages').text('هناك مناطق فارغة'+title);
                            window.location.href = '#title_label';
                        }
                    }
                    else{
        ...
        $.ajax({
            ...
            success: function(data){
                if ( data['empty'] ){
                    ...
                    $('#email-messages').text( 'يرجى إدخال رسائل البريد الإلكتروني' );
                ...
                success : function(data){
                    if ( data['error'] == true){
                        if (data['empty']){
                            $('#messages').css('display' , 'block');
                            $('#messages').removeClass('alert-success').addClass('alert-danger')
                            $('#messages').text('يرجى إدخال سؤال واحد على الأقل');
                            window.location.href = '#title_label';
                        }
                        else if ( data['double'] ){
                            $('input').css('border-bottom' , '1px solid #757575');
                        ...
                        $('#messages').text('تم إنشاء الاستطلاع بنجاح');
                        window.location.href = '#title_label';
                        window.location.replace( '<?=site_url();?>dashboard' );
                    }
                },
