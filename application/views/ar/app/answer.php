...
<div  class="row  justify-content-center" style="display: flex;justify-content:space-around;height:30px;max-width:1915px">
    <div style="width:500px;background-color:white" >
        <h6 style="text-align:right;padding-right:10px"> <?= ucfirst( $user ) ;?> من </h6> 
    </div>
</div>
                ...
                <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 100%;background-color: white;">
                    ...
                    <div class="row justify-content-center" style="height: 75%;margin-top:2%;">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">200 كلمة كحد أقصى</label>
        ...
        <div class="container-fluid mt-3" style="width: 100%;height: 250px;" >
            <div class="row justify-content-center mb-3" style="height: 100%;">
                <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 100%;background-color: white;">
                    ...
                    <div class="form-group row" style="height:50%;padding-top:10%;">
                        <label for="example-time-input" class="col-2 col-form-label">وقت</label>
                        <div class="col-10">
        ...
        <div class="container-fluid mt-3" style="width: 100%;height: 250px;" >
            <div class="row justify-content-center mb-3" style="height: 100%;">
                <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 100%;background-color: white;">
                    ...
                    <div class="form-group row" style="height:50%;padding-top:10%;">
                        <label for="example-number-input" class="col-2 col-form-label">من</label>
                        <div class="col-4">
                            <input class="form-control" type="number" style="text-align: center;" data-id="qst_<?= $qst_id ;?>_range_1">
                        </div>
                        <label for="example-number-input" class="col-2 col-form-label">الى</label>
                        <div class="col-4">
...
<div class="row justify-content-center" style="position:absolute;height:102%;width:110%;background-color:rgba(100,100,100,0.5);top:0px;display:none" id="privacy_container">
                        ...
                        <div class="row justify-content-end" style="height:10px;">   
                            ...
                            <div class="row mt-3 justify-content-center" style="height:50px;text-align:right;">   
                                <p style="padding-left:20px">  لتحسين تجربة الاستطلاع الخاصة بك ، نستخدم عنوان IP الخاص بك لتقديم مرئيات أكثر تفصيلاً للحصول على أفضل تجربة ممكنة. </p> 
                            </div>
                            <div class="row mt-3 " style="height:30px;text-align:right;">   
                                <p style="padding-left:20px">: إذا كنت لا ترغب في ذلك ، يمكنك إلغاء تنشيط الموقع </p> 
...
<div class="row mt-5 mb-3 justify-content-center" style="height:20px;">
    <h6 style="color:rgb(130,130,130);font-size:12px"> بإرسال هذا النموذج ، فأنت تقبل <a style="font-size:12px;font-weight:bold;cursor:pointer;text-decoration:underline;" id="privacy_open">  سياسة الخصوصية  </a></h6>
<div class="row">
    ...
    $(document).ready(function(){
        $('#btn-send').click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    if ( data['error'] ){
                        $('#messages').removeClass('alert-success').addClass('alert-danger').text('يجب إكمال الأسئلة الإلزامية').css('display' , 'block');
                        ...
                        $(`[id^=question]`).css('border' , '1px solid white');
                        $('#messages').removeClass('alert-danger').addClass('alert-success').css('display','block').text('...شكرا على اجاباتكم ! نعيد توجيهك في 3');
                        cpt = 2;
                        t = setInterval(function(){
                            ...
                            $('#messages').text(`...${cpt} شكرا على اجاباتكم ! نعيد توجيهك في`);
                            cpt--;
                        } , 1000);
                    } 
