        ...
        <?php if ( $this->session->userdata('logged_in') ): ?>
            <ul id="settings" style="list-style: none;">
                ...
                <div class="dropdown "  >
                    ...
                    <a class="dropdown-item" href="<?= site_url();?>" style="color: black"><i class="fas fa-home" style="color: #0079ca"></i> الصفحة الرئيسية</a>
                    ...
                    <?= form_open('users/logout'); ?>
                        <button type="submit" class="dropdown-item" style="color: black;cursor:pointer;"><i class="fas fa-sign-out-alt" style="color: rgb(104,104,104);cursor:pointer;margin-left:-17px;" ></i> خروج</button>
                    <?= form_close(); ?> 
                </div>
                </div></li>
            </ul>
...
<div style="display: none;" id="survey_container">
            ...
            <div class="col-md-6 mx-auto my-auto" style="height: 50%;background-image: url('<?= base_url('assets/img/abstract2.jpg');?>');background-size: 100%;margin-top:15vh !important" id="fofo">
                <div class="row " style="height: 17%;font-family: 'Helvetica Neue';">
                    ...
                    <div class="col-md-12" style="text-align: center;z-index: 5">
                        ...
                        <br>
                        <h1 style="color: white" id="theme_title"> حدد لونك </h1>
        ...
        <div class="row justify-content-center mainR" style="height: 42.5vh;min-height: 150px">
            ...
            <div class="col-md-4" style="height: 100%" align="center" id="test">
                ...
                <div class="group" style="margin-top: 18vh;" >
                    ...
                    <span class="bar"></span>
                    <label id="title_label">عنوان المسح</label>
                </div>
    ...
    <div id="container_add" style="position: fixed;z-index: 2">
        ...
        <ul id="menu" style="top:20px;">
            <li><a href="#bottom" id="MCQ" class="Q"><i class="far fa-dot-circle" style="color: #007bff"></i> متعدد الخيارات </a></li>
            <li><a href="#bottom" id="CXQ" class="Q"><i class="far fa-check-square" style="color: #007bff"></i> خانة الاختيار</a></li>
            <li><a href="#bottom" id="OQ" class="Q"><i class="fas fa-question" style="color: #007bff"></i> عام</a></li>
            <li><a href="#bottom" id="DATEQ" class="Q"><i class="far fa-calendar-alt" style="color: #007bff"></i> تاريخ</a></li>
            <li><a href="#bottom" id="TIMEQ" class="Q"><i class="far fa-clock" style="color: #007bff"></i> زمن</a></li>
            <li><a href="#bottom" id="RANGEQ" class="Q"><i class="fas fa-ruler-horizontal" style="color: #007bff"></i> فاصل</a></li>
        </ul>
    </div>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 252px;background-color: white;margin-top: 10px;" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                ...
                                <label class="label" style="left: 32%">سؤال <i class="far fa-dot-circle" style="color: #007bff"></i> </label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;" id="mcq_content<?= $question_id; ?>">
                            <?php foreach ($question['options'] as $option) : ?>
                                ...
                                <div class="group se">
                                    ...
                                    <label class="label">اختيار </label>
                                </div>
                        ...
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                            ...
                            <label class="switch" style="margin-left: 27%;margin-top: 25px">
                                ...
                                <p style="margin-top: 20px;margin-left: -5px;font-size: 12px;color: rgb(24,24,24);">واجب</p>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 252px;background-color: white;margin-top: 10px" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                <input type="text" value="<?= $question['question']; ?>" class="qTitle" class="shadow" maxlength="70" id="question<?= $question_id; ?>" required>
                                <span class="highlight"></span> <span class="bar"></span>
                                <label class="label" style="left: 32%">سؤال <i class="far fa-check-square" style="color: #007bff"></i> </label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;" id="mcq_content<?= $question_id; ?>">
                            <?php foreach ($question['options'] as $option) : ?>
                        ...
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                            <button class="btn btn-success cxq" id="add_opt<?= $question_id; ?>" style="height: 50px;font-weight: bold;margin-left: 32%">إضافة خيار</button>
                            <label class="switch" style="margin-left: 27%;margin-top: 25px">
                                <?php if ( $question['required'] == 1 ) : ?>
                                    <input id="question<?= $question_id; ?>required" required type="checkbox" checked> <span class="slider round"></span>
                                <?php else: ?>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 50%;background-color: white;margin-top: 10px" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                ...
                                <span class="highlight"></span> <span class="bar"></span>
                                <label class="label" style="left: 32%"> سؤال <i class="fas fa-question" style="color: #007bff"></i> </label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 50%;background-color: white;margin-top: 10px" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                <input id="question<?= $question_id; ?>" value="<?= $question['question']; ?>" type="text" class="qTitle" class="shadow" maxlength="70" required>
                                <span class="highlight"></span> <span class="bar"></span>
                                <label class="label" style="left: 32%"> سؤال <i class="far fa-calendar-alt" style="color: #007bff"></i></label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                            <label class="switch" style="margin-left: 80%;margin-top: 25px">
                    ...
                    <div class="col-md-4 shadow" style="height: 50%;background-color: white;margin-top: 10px" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                ...
                                <span class="highlight"></span> <span class="bar"></span>
                                <label class="label" style="left: 32%"> سؤال <i class="far fa-clock" style="color: #007bff"></i></label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                            <label class="switch" style="margin-left: 80%;margin-top: 25px">
                    ...
                    <div class="col-md-4 shadow" style="height: 50%;background-color: white;margin-top: 10px" id="mcq_container<?= $question_id; ?>">
                        ...
                        <div class="row justify-content-center" style="height: 70px;">
                            <div class="group">
                                <input type="text" value="<?= $question['question']; ?>" id="question<?= $question_id ?>" class="qTitle" class="shadow" maxlength="70" required>
                                <span class="highlight"></span> <span class="bar"></span>
                                <label class="label" style="left: 32%"> سؤال <i class="fas fa-ruler-horizontal" style="color: #007bff"></i></label>
                            </div>
                        </div>
                        <div class="row justify-content-center" style="height: 50px;margin-top: 20px" id="mcq_footer">
                            <label class="switch" style="margin-left: 80%;margin-top: 25px">
    ...
    <footer >
        ...
        تحديث <i class='fa fa-refresh' aria-hidden="true"></i> 
        </button>
    </footer>
                ...
                success : function(data){
                    if ( data['error'] == true){
                        if (data['empty']){
                            ...
                            $('#update-messages').text('الرجاء إدخال سؤال واحد على الأقل');
        ...
        <div style="width:150px; height:100%;background-color:white" class="shadow" align="center">
            <p style="margin-top:10px;">
                <?php if( count($answers) > 0 ): ?>
                    إجابة : <strong id="num_form" style="color:#0079ca">1</strong> / <?=count($answers);?>
                <?php else:?>
                    إجابة : <strong id="num_form" style="color:#0079ca">0</strong> / <?=count($answers);?>
                <?php endif;?>
            </p>
        </div>
    </div>
                ...
                <div class="container-fluid mt-3" style="width: 100%;height: <?= $h;?>px;" >
                    <div class="row justify-content-center mb-3" style="height: 100%;margin-top: 5px;">
                        <div class="col-md-6 col-lg-5 col-xl-4 col-12 shadow" style="height: 100%;background:white;">
                            ...
                            <?php if($question['required'] == 1) : ?>
                                <div class="row justify-content-center" style="height: 70px;">
                                    <p style="margin-left:auto;margin-right:2%;font-size: 15px;color: rgb(54, 54, 54)"><i class="fas fa-asterisk" style="font-size: 10px;color: red;"></i>واجب</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center mt-1" id="row1" style="height: 400px">
            ...
            <div class="col-md-12 col-lg-4 ml-0 ml-lg-4 mt-3 mt-lg-0 mb-5" id="bar" style="background-color: white;height: 100%"> 
                <div class="row justify-content-center mt-4 mb-3" style="height:50px;max-width:1918px">
                    <div style="width:150px; height:100%;background-color:white" class="shadow" align="center">
                        <p style="margin-top:10px;">
                            سؤال : <strong id="num_multi_bar" style="color:#0079ca">1</strong> / <?=count($multiple_choices);?>
                        </p>
        ...
        <div class="row justify-content-center mt-3" id="row2" style="height: 300px">
            ...
            <div class="col-md-12 col-lg-3 mr-0 mr-lg-4 shadow" id="round" style="height: 100%;background-color: white"> 
                ...
                <div class="row justify-content-center mt-4 mb-3" style="height:50px;max-width:1918px">
                    <div style="width:150px; height:100%;background-color:white" class="shadow" align="center">
                        <p style="margin-top:10px;">
                            سؤال : <strong id="num_multi" style="color:#0079ca">1</strong> / <?=count($multiple_choices);?>
                        </p>
