    ...
    <nav class="navbar navbar-light " style="background-color: white">
        ...
        <ul id="settings" style="list-style: none;">
            ...
            <div class="dropdown "  >
                ...
                <a class="dropdown-item" href="#" style="color: black;"><i class="fas fa-cog" style="color: rgb(104,104,104);"></i> الإعدادات</a>
        ...
        <div class="row " style="height:3%;">
                <li class="nav-item" style="list-style-type: none;"> 
                    <div class="dropdown">
                        <a id="lang" class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black;font-size: 25px"> 
                            <img src="<?= base_url('assets/img/usa.svg');?>" style="height: 20px;width: 20px;"> العربية
                        </a> 
            ...
            <div class="row justify-content-center" style="height: 3%;margin-top: 50px;">
                <div class="group"  align="center">  
                    ...
                    <input type="text" class="shadow input" placeholder="الإ سم" name="name" maxlength="30" Value="<?= $user['name'] ;?>" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 34%">الإ سم</label> -->
                </div>
            </div>
            <div class="row justify-content-center " style="height: 3%;margin-top: 40px;">
                <div class="group"  align="center">  
                    ...
                    <input type="email" class="shadow input" placeholder="البريد الإلكتروني" name="email" maxlength="30" Value="<?= $user['email'] ;?>"  >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!--<label class="label" style="left: 42%">البريد الإلكتروني</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px;">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="كلمة سر قديمة" name="old_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!--<label class="label" style="left: 20%">كلمة سر قديمة</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px;">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="كلمة مرور جديدة" name="new_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!--<label class="label" style="left: 15%">كلمة مرور جديدة</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px;">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="تأكيد كلمة المرور" name="new_password_confirm" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!--<label class="label" style="left: 20%;">تأكيد كلمة المرور</label> -->
                </div>
            </div>
