                        ...
                        <form id="email-form"> 
                                    ...
                                    <label class="sr-only" for="inlineFormInputGroupUsername">send</label>
                                        <div class="row justify-content-center" style="height:50px;"> 
                                                <div style="width:400px;background-color:white;display:flex;justify-content:space-around;" class=form-inline >
                                                    ...
                                                    <button style="width:30%;" id="copy-btn" class="btn btn-primary" type="button" onclick="copyFunction()">انسخ الرابط</button>
                                                </div>
                                        </div>
                                        <p style="margin-top:5px;"> أو</p>
                                      ...
                                      <div class="input-group" style="margin-top: 20px;">
                                        ...
                                        <input type="text"  id="emails" data-role="tagsinput"   placeholder="               ارسل إلى" >
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center mt-4" style="height: 10%;" id="subsurv">
                                <div class="col-md-7 col-lg-6 col-xl-7" style="text-align: center;">
                                      <input type="submit" class="btn btn-success" id='btn-send' value="إرسال" style="margin-bottom:10px;font-size: 20px;font-weight: bold;">
                                </div>
                            </div>
                        </form> 
                        <script>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data){
                                            if ( data['empty'] ){
                                                ...
                                                $('#email-messages').text( 'الرجاء إدخال بعض رسائل البريد الإلكتروني' );
                                                ...
                                                $('#email-messages').css('display','block');
											    $('#email-messages').removeClass('alert-success').addClass('alert-danger');
                                                $('#email-messages').text( data['emails'] + ': رسائل البريد الإلكتروني غير صالحة' );
                                                $('#btn-send').prop('disabled' , false);
                                                $('#btn-send').val('إرسال');
                                            }
                                        ...
                                        error:function(xhr, status, error){
                                            $('#email-messages').css('display','block');
											$('#email-messages').removeClass('alert-success').addClass('alert-danger');
                                            $('#email-messages').text('واجهنا مشكلة');
                                            $('#btn-send').prop('disabled' , false);
                                            $('#btn-send').val('إرسال');
											setTimeout(function(){
												$('#email-messages').fadeOut('slow');
        ...
        <div class="row " style="height: 100%;">
            <div class="col-md-8 col-lg-8 col-xl-5 mx-auto" style="height: 300px;background-image: url('<?= base_url('assets/img/send.gif');?>'),url('<?= base_url('assets/img/send2.gif');?>');background-repeat: no-repeat;background-size: 10% 50%,10% 50%;background-position:bottom left, bottom right;background-color: white;margin-top:30vh" id="fofo">
                ...
                <div class="row justify-content-center mt-1" id="secinfo" style="height: 10%;">
                    <div class="col-md-12" style="text-align: center;">
                        <h6 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 13px;"> إضغط للتعديل </h6>
                    </div>
                </div>
                ...
                <li style="float: left;">
                    <div class="dropdown " >
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" style="width: 10px !important" >
                            <a class="dropdown-item" href="<?= site_url('create-survey');?>" style="color: black"><i class="fas fa-plus" style="color: #0079ca"></i> جديد </a>
                            <a class="dropdown-item" href="<?= site_url('/upgrade');?>" style="color: black"><i class="fas fa-gem" style="color: orange"></i> تحسن </a>
    ...
    <div class="container-fluid">
        <div class="row" style="height: 350px;background-image: url('<?= base_url('assets/img/form_background.jpg');?>');">
            <h2 style="color: #f4f4f4; font-family: 'Open Sans', sans-serif; font-size: 50px; margin-left:auto;margin-right:auto;margin-top:10px;"> 
                <?= ucfirst($this->session->userdata('user_name'));?>  مرحبا
            </h2>
        </div>
    </div>
                                ...
                                <div class="front">
                                    ...
                                    <div class="content">
                                        <div class="main">
                                            ...
                                            <p class="text-center"><?= $question_form['created_at'] . ' : أنشئت في' ;?></p>
                                        </div>
                                        <div class="footer">
                                            <i class="fa fa-mail-forward"></i> مزيد من المعلومات
                                        </div>
                                    </div>
                                </div> 
                                <div class="back">
                                    <div class="header">
                                        <h5 class="motto">عندكم <?= $question_form['notifications'] ;?> إجابات جديدة </h5>
                                    </div>
                                    <div class="content">
                                        <div class="main">
