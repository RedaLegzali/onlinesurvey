        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
            ...
            <ul id="list" class="navbar-nav ml-auto">
                ...
                <li id="end_list" class="nav-item">
                    <a href="#" class="nav-link" >
                        <button class="btn btn-primary login"  style="font-weight: bold;font-size: 20px" >الدخول</button>  
                    </a>
                </li>
...
<div class="row justify-content-center" id="main" style="height: 380px;background-image: url('<?=base_url('assets/img/about_wall.jpg');?>');background-size: 100% 100% ">
    <div class="col-md-8 col-xl-5 shadow mt-4 mb-5" style="background-color: white;height: 320px;" id="main_content">
        ...
        <div class="row justify-content-center" style="height: 30%;padding-left: 10%;padding-right: 10%">
            <p>
            في هذا القسم يمكنك إدخال معلوماتك للاتصال بنا. يتم الاحتفاظ بكل بياناتك بسرية تامة. يمكنك توقع الرد في غضون 5 أيام كحد أقصى.
            </p>
        </div>
    </div>
</div>
...
<!--Section description-->
<p class="text-center w-responsive mx-auto mb-5"> هل لديك أي أسئلة أو إقتراحات؟ دعنا نعرف ! سيرد عليك فريقنا في أقرب وقت ممكن </p>
...
<div class="row justify-content-center" >
	<div class="col-md-8 col-lg-7 col-xl-6" style="text-align: right;" > 
    ...
    <div class="col-md-9 mb-md-0 mb-5" style="margin-left:5px;padding-top:5px;height:350px;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="md-form mb-0">
                        ...
                        <label for="email" class="">بريدك الإلكتروني</label>
                    </div>
                </div>
                <!--Grid column-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="md-form mb-0">
                        ...
                        <label for="subject" class="">فاعل</label>
                    </div>
                </div>
            </div>
            <!--Grid row-->
        ...
        <div class="text-center text-md-left">
            <button type="submit" class="btn btn-primary btn-block" style="color:white">إرسال</button>
		</div>
