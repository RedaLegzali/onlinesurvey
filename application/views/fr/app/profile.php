    ...
    <nav class="navbar navbar-light " style="background-color: white">
        ...
        <ul id="settings" style="list-style: none;">
            ...
            <div class="dropdown "  >
                ...
                <a class="dropdown-item" href="#" style="color: black;"><i class="fas fa-cog" style="color: rgb(104,104,104);"></i> Paramètres</a>
        ...
        <div class="col-md-8 col-lg-6 col-xl-5 mb-5 shadow" style="height: 100%;background-color: white;max-width: 650px"  id="test">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu " aria-labelledby="dropdownMenuLink" > 
                            ...
                            <a class="dropdown-item" id="spanish" style="color: black;cursor:pointer;">
                                <img src="<?= base_url('assets/img/esp.svg');?>" style="height: 20px;width: 20px"> 
                                Espanol
                            </a> 
            ...
            <div class="row justify-content-center" style="height: 3%;margin-top: 50px">
                <div class="group"  align="center">  
                    ...
                    <input type="text" class="shadow input" name="name" placeholder="Nom" maxlength="30" Value="<?= $user['name'] ;?>" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 34%">Nom</label> -->
                </div>
            </div>
            <div class="row justify-content-center " style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="email" class="shadow input" name="email" placeholder="Email" maxlength="30" Value="<?= $user['email'] ;?>"  >
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Ancien Mot de Passe" name="old_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 20%">Ancien Mot de Passe</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Nouveau Mot de Passe" name="new_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 15%">Nouveau Mot de Passe</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Confirmer Mot de Passe" name="new_password_confirm" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 20%;">Confirmer Mot de Passe</label> -->
                </div>
            </div>
