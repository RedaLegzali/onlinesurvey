        ...
        <div class="row justify-content-center " id="container" style="height: 450px;position: relative;top: 25%;" >
            <div class="col-md-9 col-lg-7 col-xl-5 shadow" style="height: 100%;background-color: white;">
                ...
                <div class="row justify-content-center" style="height: 50px;">
                    <h1 id="title">Récupérer votre Mot de Passe <i class="fas fa-key" style="color: orange;"></i></h1>
                </div>
                ...
                <!-- <form action="users/reset_password_confirm/<?=$token;?>" method="POST"> -->
                <?=  form_open( 'users/reset_password_confirm/'.$token ); ?>
                    ...
                    <div class="row justify-content-center mt-3" style="height: 40px;">
                        <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" name="email" type="email" class="form-control" id="inlineFormInputGroupPassword" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mt-3" style="height: 40px;">
                        <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                            ...
                            <div class="input-group">
                                ...
                                <input id="password" name="password" type="password" class="form-control" id="inlineFormInputGroupPassword" placeholder="Mot de Passe">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mt-3" style="height: 40px;">
                        <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                            <label class="sr-only" for="inlineFormInputGroupPassword">Confirmation de Mot de Passe</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                <div class="input-group-text"><i class="fas fa-key" style="font-size: 13px"></i></div>
                                </div>
                                <input id="password_confirm" name="password_confirm" type="password" class="form-control" id="inlineFormInputGroupPassword" placeholder="Confirmation de Mot de Passe">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mt-3" style="height: 40px;">
                        <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;min-width: 350px;">
                            <button type="submit" class="btn btn-primary my-1" style="width: 100%;font-weight: bold;">Récupérer</button>
                        </div>
                    </div>
                <?= form_close(); ?>
