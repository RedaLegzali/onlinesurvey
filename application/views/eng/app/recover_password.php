...
<div style="background-color: white;position: absolute;z-index:2;width: 100%;height: 100%;opacity: 0.7;position: fixed;"
    id="load">
    <div class="load">
        <hr />
        <hr />
...
<div class="container-fluid"
    style="background-image: url('<?= base_url('assets/img/form_background.jpg');?>');height: 100vh;">
    <div class="row justify-content-center " id="container" style="height: 450px;position: relative;top: 25%;">
        <div class="col-md-9 col-lg-7 col-xl-5 shadow" style="height: 100%;background-color: white;">
            ...
            <div class="row justify-content-center" style="height: 50px;">
                <h1 id="title">Reset Password <i class="fas fa-key" style="color: orange;"></i></h1>
            </div>
            ...
            <div class="row justify-content-center mt-3" style="height: 40px;">
                <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                    <label class="sr-only" for="inlineFormInputGroupPassword">Email</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">@</div>
                        </div>
                        <input id="email" name="email" type="email" class="form-control"
                            id="inlineFormInputGroupPassword" placeholder="Email">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                    ...
                    <div class="input-group">
                        ...
                        <input id="password" name="password" type="password" class="form-control"
                            id="inlineFormInputGroupPassword" placeholder="New Password">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center mt-3" style="height: 40px;">
                <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                    <label class="sr-only" for="inlineFormInputGroupPassword">Confirm Password</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-key" style="font-size: 13px"></i></div>
                        </div>
                        <input id="password_confirm" name="password_confirm" type="password" class="form-control"
                            id="inlineFormInputGroupPassword" placeholder="Confirm New Password">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center mt-3" style="height: 40px;">
                <div class="col-md-8 col-lg-8 col-xl-6  "
                    style="text-align: center;max-width: 500px;min-width: 350px;min-width: 350px;">
                    <button type="submit" class="btn btn-primary my-1"
                        style="width: 100%;font-weight: bold;">Recover</button>
                </div>
            </div>
            <?= form_close(); ?>
            ...
            <div class="row justify-content-center" style="height: 5%;width: 100%;margin-top: 17px;">
                <div class="col-md-12" style="text-align: center;">
                    <h6 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 13px;">© 2020
                        Copyright: Big Brothers Secure login <i class="fas fa-lock"
                            style="font-size: 13px;color: orange"></i> </h6>
                </div>
            </div>
