    ...
    <nav class="navbar navbar-light " style="background-color: white">
        ...
        <ul id="settings" style="list-style: none;">
            ...
            <div class="dropdown "  >
                ...
                <a class="dropdown-item" href="#" style="color: black;"><i class="fas fa-cog" style="color: rgb(104,104,104);"></i> Ajustes</a>
        ...
        <div class="col-md-8 col-lg-6 col-xl-5 mb-5 shadow" style="height: 100%;background-color: white;max-width: 650px"  id="test">
                ...
                <li class="nav-item" style="list-style-type: none;"> 
                    <div class="dropdown">
                        <a id="lang" class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black;font-size: 25px"> 
                            <img src="<?= base_url('assets/img/esp.svg');?>" style="height: 20px;width: 20px;"> Espanol
                        </a> 
                        <div class="dropdown-menu " aria-labelledby="dropdownMenuLink" > 
                            ...
                            <a class="dropdown-item" id="english" style="color: black;cursor:pointer;">
            ...
            <div class="row justify-content-center" style="height: 3%;margin-top: 50px">
                <div class="group"  align="center">  
                    ...
                    <input type="text" class="shadow input" placeholder="Nombre" name="name" maxlength="30" Value="<?= $user['name'] ;?>" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 34%">Nombre</label> -->
                </div>
            </div>
            <div class="row justify-content-center " style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="email" class="shadow input" placeholder="Correo Electrónico" name="email" maxlength="30" Value="<?= $user['email'] ;?>"  >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 26%">Correo Electrónico</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Antigua Contraseña" name="old_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 26%">Antigua Contraseña</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Nueva Contraseña" name="new_password" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 26%">Nueva Contraseña</label> -->
                </div>
            </div>
            <div class="row justify-content-center" style="height: 3%;margin-top: 40px">
                <div class="group"  align="center">  
                    ...
                    <input type="password" class="shadow input" placeholder="Confirma Nueva Contraseña" name="new_password_confirm" maxlength="30" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <!-- <label class="label" style="left: 0%;">Confirma Nueva Contraseña</label> -->
                </div>
            </div>
